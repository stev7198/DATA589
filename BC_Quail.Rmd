...
plot(quail_ppp, main = "", pch = 16, cex = 0.4, col = "#EFD8B6", cols = "#543111", opacity = 0.5, background = "red")
```
...
Q <- quadratcount(quail_ppp, nx = 10, ny = 10)

#Plot the quadrats and points
plot(quail_ppp, pch=16,cex=.5, use.marks = F, cols= "blue", main = "Quadrats")
